        ...
        <div className='flex items-start space-x-6 bg-blue-950/20 transition-all duration-300 p-4 sm:p-8 rounded-md'>
            ...
            <div className='flex-1'>
                ...
                <p className='text-gray-300 text-sm sm:text-base -pt-3'>
                    I’m a Front‑end Developer passionate about building modern, responsive, and user‑friendly web applications. I enjoy turning ideas into polished designs using React, Next.js, and Tailwind CSS.
                </p>
            </div>
        </div>
    </div>
